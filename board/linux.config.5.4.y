...
#
CONFIG_CC_VERSION_TEXT="aarch64-buildroot-linux-gnu-gcc.br_real (Buildroot 2024.05) 13.3.0"
CONFIG_CC_IS_GCC=y
...
# CONFIG_AMLOGIC_IKHEADERS is not set
...
CONFIG_BPF_JIT_ALWAYS_ON_AMLOGIC=y
...
#
CONFIG_FW_LOADER=y
CONFIG_EXTRA_FIRMWARE="aml_bl/backlight_pwm_overlay.dto"
...
CONFIG_AMLOGIC_PINCTRL_MODULE=y
...
# CONFIG_PINCTRL_MESON_TM2 is not set
# CONFIG_PINCTRL_MESON_SC2 is not set
# CONFIG_PINCTRL_MESON_T5D is not set
# CONFIG_PINCTRL_MESON_T7 is not set
# CONFIG_PINCTRL_MESON_S4 is not set
# CONFIG_PINCTRL_MESON_T3 is not set
CONFIG_GPIOLIB=y
...
CONFIG_THERMAL_OF=y
CONFIG_AMLOGIC_UPSTREAM_THERMAL=y
...
# CONFIG_TPS3851_WATCHDOG is not set
...
# CONFIG_REGULATOR_TPS62864 is not set
...
# CONFIG_AMLOGIC_SND_CODEC_PCM2BT is not set
# CONFIG_AMLOGIC_SND_CODEC_PDM_DUMMY_CODEC is not set
CONFIG_AMLOGIC_SND_CODEC_AMLT9015=y
# CONFIG_AMLOGIC_SND_CODEC_AMLT9015S is not set
CONFIG_AMLOGIC_SND_SOC_TAS5805=y
CONFIG_AMLOGIC_SND_SOC_TAS5805m=y
CONFIG_AMLOGIC_SND_SOC_TLV320ADC5140=y
# CONFIG_AMLOGIC_SND_CODEC_TXLX_ACODEC is not set
...
# CONFIG_AMLOGIC_SND_SOC_PCM186X is not set
# CONFIG_AMLOGIC_SND_SOC_SSM3525 is not set
# CONFIG_AMLOGIC_SND_SOC_SSM3515 is not set
# CONFIG_AMLOGIC_SND_SOC_TAS575X is not set
# CONFIG_AMLOGIC_SND_SOC_ES7243 is not set
CONFIG_AMLOGIC_SND_SOC_AD82584F=y
# CONFIG_AMLOGIC_SND_SOC_AD82587D is not set
# CONFIG_AMLOGIC_SND_SOC_AD82128 is not set
...
# CONFIG_ION_SYSTEM_CONTIG_HEAP is not set
...
CONFIG_COMMON_CLK_TM2=y
CONFIG_COMMON_CLK_SC2=y
# CONFIG_COMMON_CLK_T5D is not set
CONFIG_COMMON_CLK_T7=y
CONFIG_COMMON_CLK_S4=y
CONFIG_COMMON_CLK_T3=y
CONFIG_MESON_CLKC_MODULE=y
...
# CONFIG_AMLOGIC_BC_TIMER is not set
...
CONFIG_AMLOGIC_RESET_MESON_DOS=y
...
# CONFIG_AMLOGIC_GKI is not set
CONFIG_AMLOGIC_MODIFY=y
CONFIG_AMLOGIC_ANDROIDP=y
# CONFIG_AMLOGIC_REMOVE_OLD is not set
CONFIG_AMLOGIC_ARMV8_AARCH64=y
CONFIG_AMLOGIC_DRIVER=y
# CONFIG_AMLOGIC_ALLYESCONFIG is not set
CONFIG_AMLOGIC_MEDIA_V4L_DEC=y

#
# Amlogic dvb configuration
#
CONFIG_AMLOGIC_DVB=y
CONFIG_AMLOGIC_DVB_COMPAT=y
# end of Amlogic dvb configuration
...
#
CONFIG_AMLOGIC_MEDIA_ALGORITHM=m
...
# CONFIG_AMLOGIC_DDR_BANDWIDTH_S4 is not set
...
# CONFIG_AMLOGIC_DMC_MONITOR_S4 is not set
...
# CONFIG_AMLOGIC_VPU_CLK_DYNAMIC_ADJ is not set
...
# CONFIG_AMLOGIC_MEDIA_VIDEOCAPTURE is not set
...
# CONFIG_AMLOGIC_BL_EXTERN_I2C_LP8556 is not set
# CONFIG_AMLOGIC_BL_EXTERN_MIPI_LT070ME05 is not set
CONFIG_AMLOGIC_BL_LDIM=y
# CONFIG_AMLOGIC_BL_LDIM_IW7038 is not set
CONFIG_AMLOGIC_BL_LDIM_IW7027=y
CONFIG_AMLOGIC_BL_LDIM_BLMCU=y
# CONFIG_AMLOGIC_BL_LDIM_OB3350 is not set
...
# end of Amlogic amprime_sl Driver
...
# CONFIG_ADC_DOUBLE_SAMPLING_FOR_CVBS is not set
...
# VPP driver
#
CONFIG_AMLOGIC_MEDIA_VPP=y
# end of VPP driver
# end of Amlogic multimedia configuration

# CONFIG_AMLOGIC_PCIE is not set
...
# CONFIG_AMLOGIC_ADC_KEYPADS is not set
CONFIG_AMLOGIC_GPIO_KEY=y
CONFIG_AMLOGIC_INPUT_TOUCHSCREEN=y
CONFIG_TOUCHSCREEN_GT9XX=m
CONFIG_TOUCHSCREEN_ELAN_EKTH3915N=m
CONFIG_TOUCHSCREEN_GOODIX_GT738X=m
CONFIG_TOUCHSCREEN_GOODIX_GT738X_UPDATE=m
CONFIG_TOUCHSCREEN_GOODIX_GT738X_GESTURE=m
CONFIG_TOUCHSCREEN_GOODIX_GT738X_TOOLS=m
CONFIG_AMLOGIC_TEE=y
CONFIG_AMLOGIC_JTAG=y
CONFIG_AMLOGIC_JTAG_MESON=y
CONFIG_AMLOGIC_GX_REBOOT=y
# CONFIG_AMLOGIC_GKI_TOOL is not set
...
# CONFIG_AMLOGIC_POWER_SUPPLY is not set
...
# CONFIG_AMLOGIC_RAMDUMP is not set
CONFIG_AMLOGIC_CMA=y
CONFIG_AMLOGIC_VMAP=y
# CONFIG_AMLOGIC_VMALLOC_SHRINKER is not set
...
#
# Meson MTD RESERVED AREA MANAGEMENT Support
#
# end of Meson MTD RESERVED AREA MANAGEMENT Support
...
# CONFIG_DOLBY_FW is not set
CONFIG_AMLOGIC_CPU_INFO=y
# CONFIG_AMLOGIC_INTERNAL_PHY is not set
# CONFIG_AMLOGIC_SOC_INFO is not set
# CONFIG_GATOR is not set
# CONFIG_AES_HWKEY_GCM is not set
# CONFIG_VAD_WAKEUP_ASR is not set
